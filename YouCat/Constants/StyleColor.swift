...
class YCStyleColor {
    ...
    static let whiteGray: UIColor = UIColor(red: 0.97, green: 0.945, blue: 0.956, alpha: 1)
    static let cyan: UIColor = UIColor(red: 0.86, green: 0.92, blue: 0.94, alpha: 1)
    static let nattierblue: UIColor = UIColor(red: 0.93, green: 0.96, blue: 0.97, alpha: 1)
    static let turquoise: UIColor = UIColor(red: 0.78, green: 0.88, blue: 0.90, alpha: 1)
    static let pink: UIColor = UIColor(red: 0.92, green: 0.83, blue: 0.87, alpha: 1)
    static let lightPink: UIColor = UIColor(red: 0.945, green: 0.89, blue: 0.93, alpha: 1)
    static let whiteYellow: UIColor = UIColor(red: 0.96, green: 0.96, blue: 0.86, alpha: 1)
    static let lightPurple: UIColor = UIColor(red: 0.878, green: 0.85, blue: 0.89, alpha: 1)
